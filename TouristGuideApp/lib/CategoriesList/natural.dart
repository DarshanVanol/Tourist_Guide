...
class Natural extends StatefulWidget {
  ...
  const Natural({Key key, this.lat, this.lon}) : super(key: key);
  @override
  _NaturalState createState() => _NaturalState(lat, lon);
}
...
class _NaturalState extends State<Natural> {
  ...
  _NaturalState(this.lat, this.lon);
  Future getBeaches(String beach) async {
    String url =
        'https://api.foursquare.com/v2/venues/search?client_id=1YVDDPKVU2GWBJ4AXO1N2Z0NDVLM5XSYEJGIDGVJ5VLIXQZ3&client_secret=SBTXG4HKMKSVSV1PE0JMSH2RYYZV4GBKHXSD4LGUV14IY3HP&v=20180323&ll=$lat,$lon&radius=400000&categoryId=$natural';
